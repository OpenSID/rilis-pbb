...
class AplikasiSeeder extends Seeder
{
    ...
    {   
        ...
        $aplikasi = array(
            ...
            ["tenant_id" => $tenantId, "created_at" => Carbon::now(),  "updated_at" => Carbon::now(), "key" => "kode_kecamatan", "value" => "150", "Kode Kecamatan menyesuaikan yang di SPPT", "jenis" => "text", "kategori" => "pengaturan_wilayah", "script" => ""],
            ...
            ["tenant_id" => $tenantId, "created_at" => Carbon::now(),  "updated_at" => Carbon::now(), "key" => "kode_desa", "value" => $kodeDesa, "keterangan" => "Kode Desa menyesuaikan yang di SPPT", "jenis" => "text", "kategori" => "pengaturan_wilayah", "script" => ""],
