    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between">
                ...
                <button onclick="clickInfoKeluar()" type="button" class="btn-close btn-sm" data-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="table-responsive mt-3">
                    <table id="table-detail{{ $table }}-{{ $data->id }}" class="table table-striped table-bordered modalInfo d-none" style="width: 100%">
                        <!-- Judul tabel -->
                        <thead>
                            <tr>
            ...
            <div class="modal-footer modalInfo d-none">
                <button onclick="clickInfoKeluar()" type="button" class="btn btn-secondary" data-dismiss="modal">Keluar</button>
            </div>
        </div>
    </div>
</div>
...
@push('scripts')
    <script>
        function clickInfoKeluar() {
            $('.modalInfo').addClass('d-none');
        }
    </script>
@endpush
