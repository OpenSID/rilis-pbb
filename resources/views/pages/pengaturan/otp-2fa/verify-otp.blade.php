<x-app-layout title="Verifikasi Aktivasi OTP">

    @section('breadcrumbs')
        <x-breadcrumbs navigations="Pengaturan,OTP & 2FA" active="Verifikasi OTP"></x-breadcrumbs>
    @endsection
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="verificationForm" method="POST" action="{{ route('otp.verify-activate') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success btn-block">
                                        <i class="fas fa-check me-2"></i>Verifikasi & Aktifkan OTP
                                    </button>
                                </div>
